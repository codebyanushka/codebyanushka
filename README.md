...
I'm a **Full Stack Developer** based in **Delhi, India** — building AI-powered apps and cross-platform products using Python, Flutter, and Django.

I don't just write code — I build things that **actually work**, solve real problems, and are worth shipping.

- 🔭 Currently building: **Dermacam** (AI skin diagnosis app) & **Outfitly** (AI fashion stylist)
- 🌱 Exploring: **Flutter · Django · PostgreSQL · LLM integrations**
- 💼 Open to: **Full Stack / AI Engineer roles & internships**
- 📍 Based in: **Delhi, India**
- 📬 Reach me at: **codebyanushka@gmail.com**
...
|--------|-------------|-------|--------|
| 🩺 [**Dermacam**](https://github.com/codebyanushka/Dermacam) | AI-powered skin condition diagnosis app | Flutter, Python, CV | 🟢 Active |
| 👗 [**Outfitly**](https://github.com/codebyanushka/Outfitly) | AI personal fashion stylist app | Flutter, Python, LLM | 🟢 Active |
| 🧠 [**Emosenser**](https://github.com/codebyanushka/Emosenser) | Emotion detection using facial recognition | Python, OpenCV, ML | 🟢 Active |
| 🤖 [**Autolead AI Agent**](https://github.com/codebyanushka/Autolead-ai-agent) | Automated lead generation AI agent | Python, LangChain | 🟢 Active |
| 🎭 [**FaceAI Ultimate**](https://github.com/codebyanushka/FaceAI-Ultimate) | Multi-feature face AI toolkit | Python, CV, ML | 🟢 Active |
| 💬 [**Mental Wellness Chatbot**](https://github.com/codebyanushka/mental-wellness-chatbot) | Mood tracking & mental health journal chatbot | Python, Streamlit | ✅ Done |
